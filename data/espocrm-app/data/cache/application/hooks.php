...
return [
  'Account' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\Account\\AutoIncrementName',
        'order' => 9
      ]
    ],
    'afterRelate' => [
  ...
  'COrder' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\COrder\\RecalculateOrder',
        'order' => 9
      ]
    ],
    'afterSave' => [
      ...
      1 => [
        'className' => 'Espo\\Custom\\Hooks\\COrder\\UpdateLinkedShipment',
        'order' => 9
      ]
    ],
    'afterRemove' => [
  ...
  'COrderItem' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\COrderItem\\RecalculateOrder',
        'order' => 9
      ],
      1 => [
        'className' => 'Espo\\Custom\\Hooks\\COrderItem\\RecalculateOrderItem',
        'order' => 9
      ]
    ],
    'afterSave' => [
  ...
  'CParcel' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\CParcel\\RecalculateParcel',
        'order' => 9
      ]
    ],
    'afterSave' => [
  ...
  'CShipment' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\CShipment\\AssignShipmentName',
        'order' => 9
      ],
      1 => [
        'className' => 'Espo\\Custom\\Hooks\\CShipment\\RecalculateTotals',
        'order' => 9
      ]
    ]
  ],
